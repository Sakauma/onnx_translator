/**
  ******************************************************************************
  * @file        verify_identity.cu
  * @author      Egor Izmaylov
  * @brief       提供 Identity 算子的 CUDA 参考验证程序，供数值正确性脚本与 C 后端结果对比。
...
// 将输入逐元素复制到输出，匹配 ONNX Identity 的数值语义。
__global__ void identity_kernel(const float* input, float* output, size_t n) {
