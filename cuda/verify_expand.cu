...
int main(int argc, char** argv) {
    ...
    CUDA_CHECK(cudaMalloc(&d_input_shape, (size_t)rank_in * sizeof(int)));
    CUDA_CHECK(cudaMalloc(&d_output_shape, (size_t)rank_out * sizeof(int)));

    CUDA_CHECK(cudaMemcpy(d_input, h_input, in_bytes, cudaMemcpyHostToDevice));
    CUDA_CHECK(cudaMemcpy(d_input_shape, input_shape, (size_t)rank_in * sizeof(int), cudaMemcpyHostToDevice));
    CUDA_CHECK(cudaMemcpy(d_output_shape, output_shape, (size_t)rank_out * sizeof(int), cudaMemcpyHostToDevice));
