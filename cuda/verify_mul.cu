...
__global__ void mul_kernel_float32(const float* input_a, const float* input_b, float* output, size_t size) {
...
int main(int argc, char** argv) {
    ...
    mul_kernel_float32<<<(num_elements + 255) / 256, 256>>>(d_a, d_b, d_out, num_elements);
