/**
  ******************************************************************************
  * @file        verify_squeeze.cu
  * @author      Egor Izmaylov
  * @brief       提供 Squeeze 算子的 CUDA 参考验证程序，供数值正确性脚本与 C 后端结果对比。
...
// Squeeze 只改变形状，不改变连续内存中的元素顺序。
__global__ void squeeze_kernel(const float* input, float* output, size_t n) {
