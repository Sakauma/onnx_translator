...
- CUDA verifier：144 个。
- active numerical plan 覆盖：144 个唯一算子名称，529 条默认计划。
- active numerical plan 混合精度覆盖：378 条默认计划。
...
- 默认数值门禁当前覆盖 144 个唯一算子；尚有 0 个已实现算子未进入 active numerical plan。
