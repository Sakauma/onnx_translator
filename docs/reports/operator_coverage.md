...
- CUDA verifier：133 个。
- active numerical plan 覆盖：133 个唯一算子名称，487 条默认计划。
- active numerical plan 混合精度覆盖：348 条默认计划。
...
- 默认数值门禁当前覆盖 133 个唯一算子；尚有 0 个已实现算子未进入 active numerical plan。
