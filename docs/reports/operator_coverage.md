...
- CUDA verifier：130 个。
- active numerical plan 覆盖：130 个唯一算子名称，478 条默认计划。
- active numerical plan 混合精度覆盖：342 条默认计划。
...
- 默认数值门禁当前覆盖 130 个唯一算子；尚有 0 个已实现算子未进入 active numerical plan。
