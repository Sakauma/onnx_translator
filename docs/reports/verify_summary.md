...
- 当前安装 ONNX 最新默认 domain schema 仍有 10 个名称级缺口：Attention、CenterCropPad、Col2Im、DeformConv、ImageDecoder、RegexFullMatch、RotaryEmbedding、StringConcat、StringSplit、TensorScatter。
